...
if __name__ == '__main__':
    ...
    c_matrix = tf.Variable(tf.random_uniform([tag_count, tag_count],  -1e-4, 1e-4, dtype=tf.float32), name="c_matrix")
    ...
    with sess.as_default():
        ...
        value_y = tag_y.eval(session=sess)
        ...
        np.savetxt(os.path.join(logPath, "tag_y"), value_y)
