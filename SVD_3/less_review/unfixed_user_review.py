...
if __name__ == '__main__':
    ...
    para_file_path = os.path.join(os.getcwd(), 'settings', '0325_5.conf')
    ...
    with sess.as_default():
        ...
        total_step = int(epoch*(sample_n+1)*len(rate_list))
        ...
        fileName = "unfixed_user_review_{}_{}".format(missing_n, sample_n)
