...
if __name__ == '__main__':
    ...
    para_file_path = os.path.join(os.getcwd(), 'settings', '0406_5.conf')
    ...
    # calculate log from review matrix
    ...
    with sess.as_default():
        ...
        for step in range(total_step):
            ...
            if selection == 0:
                ...
                while True:
                    ...
                    # and another_review_matrix[movie_index][tag_index] != 1
        ...
        fileName = "unfixed_log_{}_{}".format(missing_n, sample_n)
