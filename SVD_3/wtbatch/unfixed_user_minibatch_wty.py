...
if __name__ == '__main__':
    ...
    with tf.name_scope('loss') as scope:
        ...
        l2_all = l2_weight*l2_target_p + l2_weight*l2_target_q + l2_b_extra * l2_weight*l2_target_bu + l2_b_extra * l2_weight*l2_target_bi + l2_extra * l2_weight*l2_target_sum_c    # y
    ...
    with sess.as_default():
        ...
        fileName = "unfixed_user_minibatch{}_{}_componenty".format(missing_n, sample_n)
